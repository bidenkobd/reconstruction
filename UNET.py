...
"""
if you use this script, please, reference the original paper:
https://doi.org/10.48550/arXiv.2405.05598
Bibcode: 2024JCAP...02..031F
"""
...
def UNET3D(image_size, n_base_filters=16, depth=5, dropout_rate=0.3, optimizer=Adam, initial_learning_rate=5e-4,
    ...
    y = inputs
    x = displacement_tensors(image_size)(y)
